...
templates, and package self-check evidence. It checks store/notification
handoff evidence for durable approvals, Postgres load coverage,
Slack/GitHub/email redacted payloads, and local env-held bridge config. It also
...
notes evidence fields, plus a hashed release asset manifest and owner-scoped
publication steps, before creating the GitHub release page. This check is still
offline; it does not tag, push, upload assets, or publish a release.
